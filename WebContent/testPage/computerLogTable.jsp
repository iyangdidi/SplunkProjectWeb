...
<%
String urlGo = request.getContextPath() + "/showData";
String urlAction = request.getContextPath() + "/showData?action=";
%>
<%
...
String graphURL = request.getContextPath() + "/showData?action=" +"1111";
%>
<body> 
	...
	<tr class="fixheader"> 
      ...
      <tr></tr>
        <c:if test="${not empty dataList}">
            <c:forEach items="${dataList }" var="a">
