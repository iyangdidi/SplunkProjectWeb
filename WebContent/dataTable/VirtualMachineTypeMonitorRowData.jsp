...
<%
	String url = request.getContextPath() + "/dataTable/VirtualMachineTypeMonitorRowData.jsp";
%>
...
<%
	...
	String param = key+","+showPage+","+type;
	int PageCount=0;
	List<String> list=null;
	
	ResponseGetRawData data = RequestData.requestRawDataBySource(param,RequestEnum.Request_Feild1Count_Raw_Openvswitch.getValue());
	if(data!=null){
...
<center>
  ...
  <table>
       <tr>
       <% String urlPaging = request.getContextPath() + "/dataTable/VirtualMachineTypeMonitorRowData.jsp?counts="+counts
       +"&source="+key+"&type="+type+"&showPage="; %>
      <%if(showPage>1){ %>
       <td width=150>
