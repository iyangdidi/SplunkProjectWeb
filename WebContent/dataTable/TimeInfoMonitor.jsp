...
<body> 
<%
	String url = request.getContextPath() + "/dataTable/TimeInfoMonitorRowData.jsp";
%>
	...
	<tr class="fixheader"> 
      ...
      <tr></tr>
        <%
     	...
     	ResponseCommonCountSource data = RequestData.requestCommonCountSource(null,RequestEnum.Request_SourceCount_Ntpstats.getValue());
