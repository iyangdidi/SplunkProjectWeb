...
<body> 
<%
	String url = request.getContextPath() + "/dataTable/ComputeSourceMonitorRowData.jsp";
%>
	...
	<tr class="fixheader"> 
      ...
      <tr></tr>
        <%
     	...
     	ResponseCommonCountSource data = RequestData.requestCommonCountSource(null,RequestEnum.Request_SourceCount_Nova.getValue());
