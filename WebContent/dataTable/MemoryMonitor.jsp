...
<body> 
<%
	String url = request.getContextPath() + "/dataTable/MemoryMonitorRowData.jsp";
%>
	...
	<tr class="fixheader"> 
      ...
      <tr></tr>
        <%
     	...
     	ResponseCommonCountSource data = RequestData.requestCommonCountSource(null,RequestEnum.Request_SourceCount_Ceph.getValue());
